...
void LCD_Clear2(uint16_t Color)
{
	...
	for( index = 240*240+1; index < MAX_X * MAX_Y ; index++ )
	{
		LCD_WriteData(White);
	}
}
	...
	for(i= 0; i< 13; i++){
		for(j= 0; j< 13; j++){
			if(i%2== 0 && j%2==0){
				x= i/2*6+4 + i/2*28;
				y = j/2*28+4+ j/2*6;
				LCD_DrawLine(x,y,x+28,y,Black);
				LCD_DrawLine(x,y+28,x+28,y+28,Black);
				LCD_DrawLine(x,y,x,y+28,Black);
				LCD_DrawLine(x+28,y,x+28,y+28,Black);
			}
		}
	}
}

void LCD_creamurietempo(){
	// 70 largo 
	LCD_DrawLine(10,260,80,260,Black);
	LCD_DrawLine(10,310,80,310,Black);
	LCD_DrawLine(10,260,10,310,Black);
	LCD_DrawLine(80,260, 80,310,Black);
	
	GUI_Text(15, 265, (uint8_t *) "       ", Black, White);
	GUI_Text(15, 265, (uint8_t *) "Muri G1", Black, White);
	GUI_Text(23, 285, (uint8_t *) "  8  ", Black, White);

	LCD_DrawLine(85,260,155,260,Black);
	LCD_DrawLine(85,310,155,310,Black);
	LCD_DrawLine(85,260,85,310,Black);
	LCD_DrawLine(155,260,155,310,Black);
	
	LCD_DrawLine(160,260,230,260,Black);
	LCD_DrawLine(160,310,230,310,Black);
	LCD_DrawLine(160,260,160,310,Black);
	LCD_DrawLine(230,260,230,310,Black);
	
	GUI_Text(165, 265, (uint8_t *) "       ", Black, White);
	GUI_Text(165, 265, (uint8_t *) "Muri G2", Black, White);
	GUI_Text(173, 285, (uint8_t *) "  8  ", Black, White);
}
